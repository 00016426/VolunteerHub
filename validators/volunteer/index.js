...
const addApplicationValidation = () => {
  return [
    body('jobName')
      .notEmpty().withMessage('You should write about the job title')
      .isLength({ min: 8, max: 255 }).withMessage('Job description must be between 8 and 255 characters long'),
    body('eventDateTime')
    ...
    body('application')
      .notEmpty().withMessage('Application Number must not be empty'),      
  ];
};
